...
class Game {
  ...
  constructor(contGame, level, prog, chor, speed, maxMilliseconds) {
    ...
    this.uriJson = "https://api-rest-ff4e7-default-rtdb.firebaseio.com/api/users.json"; // path data JSON
    this.pathImg = this.folderPath + "/assets/img/memory/"; // path data imgs 
    this.pathImgDafault =  this.folderPath + "/assets/img/memory/img_default.jpg"; // path data img default 
